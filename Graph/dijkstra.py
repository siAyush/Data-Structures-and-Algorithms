...
class Dijkstra(object):
    ...
    def calculate_shortests_path(self, vertexList, startVertex):
    ...
    def get_shortest_path_to(self, targetVertex):
...
D = Dijkstra()
D.calculate_shortests_path(vertexList, node1)
D.get_shortest_path_to(node4)
